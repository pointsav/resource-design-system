...
| token-orange | `#F15F22` | `#FDE8DD` | Equity partner; named individual; Client A-group entity |
...
| token-magenta | `#9F1853` | `#FFD6E8` | Legacy corporate (Client A Corporation pre-reorganization) |
| token-teal | `#005D5D` | `#9EF0F0` | Legacy asset company (Client A Real Assets pre-reorganization) |
...
**Client A green 2026-06-03:** `#198038` (design-system green) → `#54924E` (WCP canonical green). The darker Carbon-style green failed at 9–10px font weights against the `#EEF6EC` background. Operator decision ratified (commit `57960322`).
