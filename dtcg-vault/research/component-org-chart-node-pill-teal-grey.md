...
SPV role). The Client A Organization_JW2 and SPV2_JW2 org charts introduced two
...
Client A charts: `dotted` signals a pass-through or unresolved relationship;
...
3. Confirmed Client A charts use the same dotted style consistently for both
